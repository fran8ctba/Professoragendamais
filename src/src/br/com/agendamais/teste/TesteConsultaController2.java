...
public class TesteConsultaController2
{
    ...
    public static void main(String[] pArgs) throws ParseException
    {
        ...
        //
        // Criar um paciente
        Paciente tPacienteA = new Paciente(0,"email@hotmail.com", "senha", "Yerlandia Westrocia", LocalDate.of(1978, 8, 29), 3456767, 37834534452L);
        Paciente tPacienteB = new Paciente(0,"email1@hotmail.com", "senha1", "Yerlandia Westrocia", LocalDate.of(1978, 8, 29), 3456767, 37834534452L);
        ...
        // Criar um medico
        Medico tMedicoA = new Medico(0, "email@gmail.com", "senha", "Estroncio Vago", 3432, "Urologista");
        ...
        Paciente tPacienteC = new Paciente(99999, "restro@gmail.com", "senha2", "nono nono", LocalDate.now(), 1, 1L);
